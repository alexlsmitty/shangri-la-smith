...
const restaurants = ref([
  {
    ...
    details:
      'Indulge in innovative flavor combinations and impeccable service for a truly memorable fine dining experience. The Beach House is perfect for special occasions or a luxurious evening out.',
  ...
  },
  {
    ...
    description:
      'For a more casual and laid-back dining experience, head to The Sand Bar. Situated right on the beach, this vibrant grill offers a relaxed atmosphere where you can enjoy delicious food with your toes in the sand.',
    details:
      'Savor grilled specialties, fresh salads, and satisfying sandwiches, all while soaking in the sun and enjoying the ocean breeze. The Sand Bar is the perfect spot for a casual lunch, a refreshing afternoon snack, or a relaxed dinner under the stars.',
  ...
  },
  {
    ...
    description:
      'Stay refreshed and energized without leaving the poolside at The Poolside Cafe. This convenient and casual spot offers a variety of light bites, including salads, wraps, and snacks, as well as a wide selection of refreshing beverages.',
    details:
      "From tropical cocktails to chilled juices, it's the perfect place to grab a quick and tasty meal or a cool drink while enjoying the sun and the pool.",
  ...
  },
  {
    ...
    description:
      'Unwind and socialize in the elegant setting of The Lobby Lounge. This sophisticated lounge offers a curated selection of handcrafted cocktails, fine wines, and premium spirits.',
    details:
      'Enjoy light appetizers and small plates in a stylish atmosphere, often accompanied by live music in the evenings. The Lobby Lounge is the perfect place to start your evening, enjoy a nightcap, or simply relax and soak in the refined ambiance.',
          ...
          <v-container>
            <div class="dining-hero-content">
              ...
              <p class="text-h6 mb-8 text-white max-width-text">
                Indulge in a diverse range of dining experiences at Shangri La Beach Resort. From
                elegant fine dining to casual beachfront bites, our restaurants and bars offer
                something to tantalize every taste bud and create unforgettable culinary moments.
              </p>
              <v-btn
                color="secondary"
                size="large"
        ...
        <v-row class="mb-10">
          <v-col cols="12" class="text-center">
            ...
            <p class="text-subtitle-1 mb-8 max-width-text mx-auto">
              Each of our dining venues offers a unique experience, from romantic ocean-view dining
              to casual beachside fare, ensuring there's something to satisfy every palate.
            </p>
          </v-col>
        </v-row>
                ...
                <v-col cols="12" md="7">
                  ...
                  <v-card-text>
                    ...
                    <v-row class="mt-4">
                      ...
                      <v-col cols="12" sm="6">
                        <v-btn block color="secondary" @click="toggleMenu(restaurant)">
                          View Sample Menu
      ...
      <v-card class="pa-4">
        ...
        <v-card-text>
          ...
          <p class="text-caption mt-4">
            * This is a sample menu. Actual offerings may vary. Please contact the restaurant for
            the current menu.
          </p>
        </v-card-text>
        <v-card-actions>
