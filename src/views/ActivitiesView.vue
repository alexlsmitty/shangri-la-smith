...
const preloadFeaturedImages = () => {
  activities.value.onsite
    .filter((a) => a.featured)
    .forEach((activity) => {
      preloadImage(activity.image)
    })
  activities.value.excursions
    .filter((a) => a.featured)
    .forEach((activity) => {
      preloadImage(activity.image)
    })
  ...
  onsite: [
    {
      ...
      details:
        'Our experienced instructors lead sessions suitable for all levels. Mats and props are provided.',
    ...
    },
    {
      ...
      description:
        'Find inner peace and tranquillity with our guided meditation sessions in the serene garden.',
      details:
        'Perfect for beginners and experienced practitioners alike. Focus on mindfulness and relaxation techniques.',
    ...
    },
    {
      ...
      description:
        'Unwind on our pristine private beach with complimentary sun loungers and umbrellas.',
      details:
        'Beach attendants are available to assist with setup and provide refreshments throughout the day.',
    ...
    },
    {
      ...
      description:
        'Take a refreshing dip in our stunning infinity pool with breathtaking ocean views.',
      details:
        'Pool attendants provide towels and refreshments. Adult-only hours from 7:00 PM - 10:00 PM.',
    ...
    },
    {
      ...
      details:
        'Guided sessions available for beginners. Equipment provided at the water sports center.',
    ...
    },
    {
      ...
      details:
        'Equipped with cardio machines, free weights, and multi-functional training equipment. Personal trainers available upon request.',
    ...
    },
    {
      ...
      description:
        "Let your children enjoy fun and engaging activities with our supervised Kids' Club.",
      details:
        'Age-appropriate activities including arts and crafts, games, and educational programs. Supervised by trained staff.',
  ...
  excursions: [
    {
      ...
      description:
        'Embark on a guided snorkeling tour to explore the vibrant coral reefs and encounter diverse marine life.',
      details:
        'Transportation to prime snorkeling spots. Professional guides provide safety instructions and information about the local marine ecosystem.',
    ...
    },
    {
      ...
      details:
        'Visit three different islands, each with unique landscapes and attractions. Includes lunch and refreshments.',
    ...
    },
    {
      ...
      details:
        'Guided hike through diverse ecosystems. Opportunity to swim in natural pools beneath waterfalls. Moderate fitness level recommended.',
    ...
    },
    {
      ...
      details:
        'Includes champagne, canapés, and live music. Perfect for couples and special occasions.',
    ...
    },
    {
      ...
      details:
        'Guided tour through a traditional village. Interact with local artisans and learn about cultural practices. Opportunity to purchase authentic handicrafts.',
    ...
    },
    {
      ...
      details:
        'Led by a local chef. Includes market visit to select fresh ingredients, cooking instruction, and enjoying your prepared meal.',
    ...
    },
    {
      ...
      details:
        'Authentic cultural showcase featuring local performers. Learn about the history and significance of traditional performances.',
    ...
    },
    {
      ...
      details:
        'Various dive sites for all experience levels. PADI-certified instructors. Equipment rental available.',
    ...
    },
    {
      ...
      details:
        'Guided tour of a conservation-focused wildlife sanctuary. Learn about local species and conservation efforts.',
    ...
    },
    {
      ...
      details:
        'Professional fishing guides and equipment provided. Target species include marlin, tuna, and mahi-mahi.',
...
const activitiesByCategory = computed(() => {
  ...
  if (searchQuery.value) {
    ...
    activitiesToGroup = activitiesToGroup.filter(
      (activity) =>
...
function toggleAllActivities() {
  ...
  if (showAllActivities.value) {
    ...
    expandedPanels.value = Array.from(
      { length: categoriesWithActivities.value.length },
      (_, i) => i,
    )
  } else {
          ...
          <v-container>
            <div class="activities-hero-content">
              ...
              <p class="text-h6 mb-8 text-white max-width-text">
                Discover the wonders of our tropical paradise and create unforgettable memories with
                our curated selection of activities and excursions. From relaxation to adventure,
    ...
    <section ref="activitiesSection" class="py-12 bg-surface-variant">
      <v-container>
        ...
        <div class="text-center mb-8 mt-6">
          <v-btn color="primary" size="large" @click="toggleAllActivities" rounded class="px-6">
            <v-icon left class="mr-2">{{
              showAllActivities ? 'mdi-chevron-up' : 'mdi-chevron-down'
            }}</v-icon>
                ...
                >
                  <div class="d-flex align-center justify-space-between w-100">
                    <div class="d-flex align-center">
                      <v-icon size="large" color="white" class="mr-4">
                        {{
                          category === 'Relaxation & Rejuvenation'
                            ? 'mdi-spa'
                            : category === 'Adventure & Recreation'
    ...
    <v-dialog v-model="showDetailModal" max-width="800" scrollable>
      <v-card v-if="selectedActivity" class="activity-detail-card">
            ...
            <v-col cols="12">
              ...
              >
                <p class="mb-0" v-if="selectedActivity.id <= 10">
                  This is an on-site resort activity. Please check with the concierge or activities
                  desk for current availability.
                </p>
                <p class="mb-0" v-else>
                  This is a local excursion. Advance booking is recommended. Transportation to and
                  from the resort is included.
                </p>
              </v-alert>

              <p class="text-body-2">
                Please note that all activities are subject to weather conditions and availability.
                For more information or to inquire about specific dates, please contact our resort
                concierge.
              </p>
            </v-col>
          </v-row>
        ...
        <v-card-actions class="pa-6 pt-0">
          <v-spacer></v-spacer>
          <v-btn color="secondary" variant="flat" @click="showDetailModal = false"> Close </v-btn>
          <v-btn
            color="primary"
            class="ml-2"
            @click="
            ...
            <v-card class="elevation-3 rounded-lg pa-6">
              ...
              <v-list>
                <v-list-item>
                  ...
                  <v-list-item-title
                    >Our concierge team is available to assist you with booking activities and
                    excursions.</v-list-item-title
                  >
                </v-list-item>
                <v-list-item>
                  <template v-slot:prepend>
                  ...
                  <v-list-item-title
                    >Please inquire about availability and pricing for specific
                ...
                <v-list-item>
                  ...
                  <v-list-item-title
                    >Transportation to and from excursion locations can be
                    arranged.</v-list-item-title
                  >
                </v-list-item>
                <v-list-item>
                  <template v-slot:prepend>
                  ...
                  <v-list-item-title
                    >Advance bookings are recommended, especially during peak
                    season.</v-list-item-title
                  >
                </v-list-item>
              </v-list>
            </v-card>
